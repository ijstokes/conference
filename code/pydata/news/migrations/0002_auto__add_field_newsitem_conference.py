...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'NewsItem.conference'
        db.add_column(u'news_newsitem', 'conference',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['events.Conference']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'NewsItem.conference'
        db.delete_column(u'news_newsitem', 'conference_id')
